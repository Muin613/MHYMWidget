 ...
 * Create Time: 2017/5/26 8:36
 * Modify by : Administrator
 * Modify Time: 2017/5/26 8:36
 * Modify Remarks:
 */

public class MoveFrameLayout extends FrameLayout {
    private static final String TAG = MoveFrameLayout.class.getSimpleName();
...
//        mShadowDrawable = getResources().getDrawable(R.drawable.shadow_left);
    ...
    public void addBitmap(Bitmap bitmap) {
        this.bitmap = bitmap;
        if (bitmap != null)
            mShadowDrawable = new BitmapDrawable(getResources(), bitmap);
//            decor.setBackground(new BitmapDrawable(getResources(),bitmap));
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (callback != null)
            if (callback.canMoveLeftOrRight(false)) {
                System.out.println("laile   bunengdong");
                return true;
            }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                System.out.println("shenmegui " + moveX + " " + downX);
                if (moveX - downX >= 0 && isSilding) {
                    if (moveX - downX < viewWidth) {
                        moveCX = moveX - downX;
...
//            mShadowDrawable.setBounds(left+720-moveCX, top, right+720-moveCX, bottom);
...
//    }
    ...
    public interface Callback {
        boolean canMoveLeftOrRight(boolean flag);
    }
